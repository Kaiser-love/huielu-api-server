...
import com.ronghui.service.common.request.RequestItem;
...
public class SqlConstant {
    ...
    public static String SELECT_QUERY_SIZE = "select count(*) from ";
    public static String QUERY_TABLIE_COLUMN = "SELECT column_name FROM information_schema.Columns WHERE table_name= ";
    public static String QUERY_ALL_TABLE = "SELECT table_name FROM information_schema.tables WHERE  table_schema= 'ronghui' ";
    ...
    static {
        EntityToSqlMap.put("conference", "Conference");
